...
def preprocess(input_data:Property):
    ...
    if isinstance(input_data, House):
        ...
        "open_fire": boolean_to_integer(df["open_fire"].get(0)),
        "number_of_facades": df["facades_number"].get(0),
        ...
        return df["property_type"].get(0), list(translated_apartment_data.values())
